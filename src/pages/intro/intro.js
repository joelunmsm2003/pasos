...
var IntroPage = /** @class */ (function () {
    function IntroPage(server, appCtrl, toastCtrl, _photo, alertCtrl, http, mapService, geolocation, zone, platform, modalCtrl, socialSharing, storage, _perfil, _categoria, navCtrl, navParams) {
        var _this = this;
        this.server = server;
    ...
    ///Saca ubicacion
    IntroPage.prototype.currentLocation = function () {
        var _this = this;
    ...
    IntroPage.prototype.getAddress = function (latLngObj) {
        var _this = this;
